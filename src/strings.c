...
const u8 gText_Energypowder_50[] = _("NET BALL{CLEAR_TO 0x74}{SMALL}50");
const u8 gText_EnergyRoot_80[] = _("NEST BALL{CLEAR_TO 0x74}{SMALL}80");
...
ALIGNED(4) const u8 gString_PokemonGarbageGreen_Staff[] = _("Pokémon GarbageGreen Version\nEditors");
ALIGNED(4) const u8 gCreditsString_HackProducer[] = _("\n\nHack Producer\n\n\n\n");
ALIGNED(4) const u8 gCreditsString_Jan_Pokemon_Challenges[] = _("\n\n\nJan\na.k.a.\nPokémon Challenges\n\n\n");
ALIGNED(4) const u8 gCreditsString_LeadDesigner[] = _("\n\nLead Designer\n\n\n");
ALIGNED(4) const u8 gCreditsString_Spegasparce[] = _("\n\nSpegasparce\n\n");
ALIGNED(4) const u8 gCreditsString_CodeMasters[] = _("\nCode Wizards\n\n");
ALIGNED(4) const u8 gCreditsString_Toxic_Not_Suicuu[] = _("\nNot Suicuu\n\nToxicenduser\n\n\n\n");
ALIGNED(4) const u8 gCreditsString_PokemonLeafGreen_Staff[] = _("Pokémon LeafGreen Version\nStaff");
